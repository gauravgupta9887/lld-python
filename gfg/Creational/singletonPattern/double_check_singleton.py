# It is easy to notice that once an object is created, 
# the synchronization of the threading is no longer useful 
# because now object will never be equal to None and any sequence of operations 
